...
public class FanpageStatistics implements Serializable {
    ...
    public FanpageStatistics dayCount(Integer dayCount) {
    ...
    public FanpageStatistics monthCount(Integer monthCount) {
    ...
    public FanpageStatistics yearCount(Integer yearCount) {
    ...
    public FanpageStatistics inDay(Integer inDay) {
        this.inDay = inDay;
        return this;
    }
    ...
    public FanpageStatistics inMonth(Integer inMonth) {
    ...
    public FanpageStatistics inYear(Integer inYear) {
        this.inYear = inYear;
        return this;
    }
    ...
    public FanpageStatistics status(CheckStatus status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        FanpageStatistics fanpageStatistics = (FanpageStatistics) o;
