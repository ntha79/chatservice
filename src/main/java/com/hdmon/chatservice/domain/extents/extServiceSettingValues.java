...
public class extServiceSettingValues implements Serializable {
    ...
    public extServiceSettingValues()
    {
        super();
    }

    public extServiceSettingValues(Long maxTimeToAction, Long maxMember, boolean allowDelete, boolean allowEdit, boolean allowBlock, boolean allowRemove, boolean allowSendMsgAfterBlock, boolean allowLeave)
    {
